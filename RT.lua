...
local Window = Library:CreateWindow("Rt.exe", Vector2.new(492, 598), Enum.KeyCode.RightShift)
game.StarterGui:SetCore("SendNotification", {
    Title = "RT.exe made by elsker jadder";
    Text = "Hello, Loading...";
...
local CreditsSection = CreditsTab:CreateSector("Rt.exe", "left")
local discord = CreditsSection:AddButton("elsker jadder", function(bool)
    setclipboard("elsker jadder is a king ")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Rt.exe";
...
local esko = CreditsSection:AddButton("Owned by Rt.exe", function(bool)
    setclipboard("elsker jadder is a king ")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Rt.exe";
...
local discord1 = CreditsSection:AddButton("elsker jadder", function(bool)
...
local discord2 = CreditsSection:AddButton("elsker jadder is a king ", function(bool)
...
local discord3 = CreditsSection:AddButton("elsker jadder is a king ", function(bool)
    setclipboard("http://Rt.exe Elsker jadder#5205")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Rt.exe";
...
local partnersSection = CreditsTab:CreateSector("Neger right")
local partners1 = partnersSection:AddButton("elsker jadder is a king ", function(bool)
    setclipboard("elsker jadder is a king ")
    game.StarterGui:SetCore("SendNotification", {
        Title = "Rt.exe";
...
print("| [Rt.exe] Executed version: 6.0")
print("| [Rt.exe] Your user is: "..game.Players.LocalPlayer.Name.. "") 
print("| [Rt.exe] Your id is: "..game.Players.LocalPlayer.UserId.. "")
print("| [Rt.exe] Job id: " ..game.JobId.. "")
print("| [Rt.exe] Join us discord.gg/axq                 ")
print("| [Rt.exe] Made by ekso <@804245361894883339>     ")
print("| [Rt.exe] Website - https://Rt.exe         ")
...
warn("---------------------------")
print("                          ")
print("[Rt.exe] Kicu kreci lody")
print("[Rt.exe] Kc waneska<3")
wait(69420)
end